...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kipz', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '(╹ڡ╹ )爱吃🍔🍟🍕🥤🍗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kipz-blog.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, 博客, Kipz', // 网站关键词 英文逗号隔开
