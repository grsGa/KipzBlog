...
module.exports = {
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/snow_miku/model.json', // 当前使用的挂件是编号28的miku；挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
